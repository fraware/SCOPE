...
class EngineFactory:
    ...
    def __init__(
        ...
        *,
        ...
        self._engines: dict[tuple[str, str, str, str], ScopeEngine] = {}

    def _resolve_config(self, headers: dict[str, str]) -> tuple[Path, str | None, str, str]:
        ...
        return policy_dir, ledger_path, store_type, session_dir

    def from_headers(self, headers: dict[str, str]) -> ScopeEngine:
        policy_dir, ledger_path, store_type, session_dir = self._resolve_config(headers)
        cache_key = (str(policy_dir), str(ledger_path or ""), store_type, session_dir)
